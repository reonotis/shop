                ...
                <form method="post" action="{{ route('admin.shop.storeConfirm'); }}" >
                    ...
                    <div class="shopCreateSection" >
                        ...
                        <div class="input-label-container">
                            <input type="text" name="shop_name" id="shop_name" class="input-control" value="{{ old('shop_name') }}" placeholder=" " required>
                            <label class="input-label" for="shop_name">店舗名</label>
                        </div>
                        <div class="input-label-container">
                            <input type="email" name="shop_mail_address" id="shop_mail_address" class="input-control" value="{{ old('shop_mail_address') }}" placeholder=" " required>
